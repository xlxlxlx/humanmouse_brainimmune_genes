-- Usage: sqlite3 climate_primate.db < protein_nonprimate_brainimmu_thre80.sql

DROP TABLE protein_nonprimate_brainimmu_thre80;
CREATE TABLE protein_nonprimate_brainimmu_thre80 (
